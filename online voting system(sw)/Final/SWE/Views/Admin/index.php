        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="addvoter.php"><i class="fas fa-user"></i><span>voters</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="election.php"><i class="fas fa-table"></i><span>Elections</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="candidate.php"><i class="far fa-user-circle"></i><span>Candidates</span></a></li>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="text-primary font-weight-bold m-0">Elections</h6>
                            </div>
                            <div class="card-body">
                                <h4 class="small font-weight-bold"><span class="float-right">20%</span></h4>
                                <h4 class="small font-weight-bold">ahly<span class="float-right">80%</span></h4>
                                <div class="progress mb-4">
                                    <div class="progress-bar bg-info" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%;"><span class="sr-only">80%</span></div>
                                </div>
                                <h4 class="small font-weight-bold">zamalek<span class="float-right">Complete!</span></h4>
                                <div class="progress mb-4">
